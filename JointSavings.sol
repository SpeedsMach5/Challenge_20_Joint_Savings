...
To automate the creation of joint savings accounts, you will create a solidity smart contract that accepts two user addresses that are then able to control a joint savings account. Your smart contract will use 
ether management functions to implement various requirements from the financial institution to provide the features of the joint savings account.
...
contract JointSavings {
    ...
    - Two variables of type `uint public` named `uint public` and `contractBalance`.
    */
    // YOUR CODE HERE!
        address payable accountOne = 0xCB1DD12b0f8a9a5Bf0F51284149676bD127a085F;
        address payable accountTwo = 0x66631CAd13E761Cb30790AD5625272Ea7b2E4547;
    ...
    */
    function setAccounts(address payable account1, address payable account2) public{
        ...
        accountOne = account1;        accountTwo = account2;     
    }
